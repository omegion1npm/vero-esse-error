...
[![Build](https://img.shields.io/travis/postcss/@omegion1npm/vero-esse-error/master)](https://travis-ci.org/postcss/@omegion1npm/vero-esse-error)
[![Version](https://img.shields.io/npm/v/@omegion1npm/vero-esse-error)](https://github.com/omegion1npm/vero-esse-error/blob/master/CHANGELOG.md)
[![postcss compatibility](https://img.shields.io/npm/dependency-version/@omegion1npm/vero-esse-error/peer/postcss)](https://postcss.org/)
...
@omegion1npm/vero-esse-error in your plugin chain will allow you to adjust assets `url()` (or
...
- If you are looking for **Glob Imports**, you can use [@omegion1npm/vero-esse-error-ext-glob](https://github.com/dimitrinicolas/@omegion1npm/vero-esse-error-ext-glob) to extend @omegion1npm/vero-esse-error.
- If you want to import remote sources, you can use [@omegion1npm/vero-esse-error-url](https://github.com/unlight/@omegion1npm/vero-esse-error-url) with its `dataUrls` plugin option to extend @omegion1npm/vero-esse-error.
...
```console
$ npm install -D @omegion1npm/vero-esse-error
```
...
const atImport = require("@omegion1npm/vero-esse-error")
...
By default `@omegion1npm/vero-esse-error` warns when an empty file is imported.  
...
`@omegion1npm/vero-esse-error` adds a message to `result.messages` for each `@import`. Messages are in the following format:
